...
<div id="costbenefitprojection">
    <form action="index.php?option=com_costbenefitprojection&amp;id=<?php echo $this->item->id ?>"
        ...
        <button onclick="Joomla.submitbutton('riskdata.save')" class="uk-button uk-button-primary"><i class="uk-icon-save"></i> Save</button> 
        <button onclick="Joomla.submitbutton('riskdata.cancel')" class="uk-button"><i class="uk-icon-times"></i> Close</button>
