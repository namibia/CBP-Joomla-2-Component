...
if ($results['disease']){
	...
	$height = ($i * 70)+100;
	$chart->load(json_encode($data));
	$options = array( 'backgroundColor' => $this->Chart['backgroundColor'], 'width' => $this->Chart['width'], 'height' => $height, 'chartArea' => $this->Chart['chartArea'], 'legend' => $this->Chart['legend'], 'vAxis' => $this->Chart['vAxis'], 'hAxis' => array('textStyle' => $this->Chart['hAxis']['textStyle'], 'title' => JText::_('COM_COSTBENEFITPROJECTION_CHARTS_WORK_DAYS_LOST_PERCENT_OE_SUBTITLE'), 'titleTextStyle' => $this->Chart['hAxis']['titleTextStyle']));
...
<ul id="chartWDLP" class="uk-switcher">
    <li class="uk-active default" >
    	<div id="wdlp_default_div" class="chart" style="height:100%; width:100%;"></div>
        <button class="uk-button uk-button-primary uk-button-mini uk-hidden-small" onclick="getPDF(document.getElementById('wdlp_default_div'),'<?php echo JText::_('COM_COSTBENEFITPROJECTION_CHARTS_WORK_DAYS_LOST_PERCENT'); ?>' 
		+' (<?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_DEFAULT'); ?>)');">
        <?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_PDF_DOWNLOAD'); ?></button>
    </li>
    <li class="scalling" >
    	<div id="wdlp_sf_div" class="chart" style="height:100%; width:100%;"></div>
        <button class="uk-button uk-button-primary uk-button-mini uk-hidden-small" onclick="getPDF(document.getElementById('wdlp_sf_div'),'<?php echo JText::_('COM_COSTBENEFITPROJECTION_CHARTS_WORK_DAYS_LOST_PERCENT'); ?>' 
		+' (<?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_INCLUDE_SCALING_FACTORS'); ?>)');">
        <?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_PDF_DOWNLOAD'); ?></button>
    </li>
    <li class="episode" >
		<div id="wdlp_oe_div" class="chart" style="height:100%; width:100%;"></div>
        <button class="uk-button uk-button-primary uk-button-mini uk-hidden-small" onclick="getPDF(document.getElementById('wdlp_oe_div'),'<?php echo JText::_('COM_COSTBENEFITPROJECTION_CHARTS_WORK_DAYS_LOST_PERCENT'); ?>' 
