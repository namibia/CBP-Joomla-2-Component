...
<ul id="chartWDL" class="uk-switcher">
    <li class="uk-active default" >
    	<div id="wdl_default_div" class="chart" style="height:100%; width:100%;"></div>
        <button class="uk-button uk-button-primary uk-button-mini uk-hidden-small" onclick="getPDF(document.getElementById('wdl_default_div'),'<?php echo JText::_('COM_COSTBENEFITPROJECTION_CHARTS_WORK_DAYS_LOST_TITLE'); ?>' 
		+' (<?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_DEFAULT'); ?>)');">
        <?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_PDF_DOWNLOAD'); ?></button>
    </li>
    <li class="scalling" >
    	<div id="wdl_sf_div" class="chart" style="height:100%; width:100%;"></div>
        <button class="uk-button uk-button-primary uk-button-mini uk-hidden-small" onclick="getPDF(document.getElementById('wdl_sf_div'),'<?php echo JText::_('COM_COSTBENEFITPROJECTION_CHARTS_WORK_DAYS_LOST_TITLE'); ?>' 
		+' (<?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_INCLUDE_SCALING_FACTORS'); ?>)');">
        <?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_PDF_DOWNLOAD'); ?></button>
    </li>
    <li class="episode" >
		<div id="wdl_oe_div" class="chart" style="height:100%; width:100%;"></div>
        <button class="uk-button uk-button-primary uk-button-mini uk-hidden-small" onclick="getPDF(document.getElementById('wdl_oe_div'),'<?php echo JText::_('COM_COSTBENEFITPROJECTION_CHARTS_WORK_DAYS_LOST_TITLE'); ?>' 
