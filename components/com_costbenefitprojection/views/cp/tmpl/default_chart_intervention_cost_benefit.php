...
<ul id="chartICB" class="uk-switcher">
    <li class="uk-active default" >
    	<?php $i = 0; $len = count($results['interventions']); foreach ($results['interventions'] as $intervention) :?>
            ...
            <button class="uk-button uk-button-primary uk-button-mini uk-hidden-small" onclick="getPDF(document.getElementById('icb_<?php echo $i; ?>_default_div'),'<?php echo JText::_('COM_COSTBENEFITPROJECTION_CHARTS_INTERVENTION_COST_BENEFIT_TITLE'); ?>' 
    ...
    <li class="scalling" >
    	<?php $i_HAS_SF = 0; $len = count($results['interventions']); foreach ($results['interventions'] as $intervention) :?>
            ...
            <br/>
            <?php endif; ?>
            <div id="icb_<?php echo $i_HAS_SF; ?>_sf_div" class="chart" style="height:100%; width:100%;"></div>
            <button class="uk-button uk-button-primary uk-button-mini uk-hidden-small" onclick="getPDF(document.getElementById('icb_<?php echo $i_HAS_SF; ?>_sf_div'),'<?php echo JText::_('COM_COSTBENEFITPROJECTION_CHARTS_INTERVENTION_COST_BENEFIT_TITLE'); ?>' 
