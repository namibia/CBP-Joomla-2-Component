...
class CostbenefitprojectionControllerUser extends JControllerForm
{
	/**
	 * @var    string  The prefix to use with controller messages.
	 * 
	 */
	protected $text_prefix = 'COM_COSTBENEFITPROJECTION_USER';
	...
	public function save($key = null, $urlVar = null)
	{
		...
		if (isset($data['password']) && isset($data['password2']))
		{
			...
			if ($data['password'] != $data['password2'])
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_costbenefitprojection&view=user&layout=edit', false));
			}
