...
class CostbenefitprojectionViewCountry extends JView
{
	protected $item;
	protected $form;
	protected $xml;
	...
	public function addToolbar()
	{
		...
		if ($this->item->country_id) {
			JToolBarHelper::title(JText::_('COM_COSTBENEFITPROJECTION_EDIT_COUNTRIES_TITLE'), 'country-edit');
		} else {
			JToolBarHelper::title(JText::_('COM_COSTBENEFITPROJECTION_ADD_COUNTRIES_TITLE'), 'country-add');
		}

		JToolBarHelper::apply('country.apply', 'JTOOLBAR_APPLY');
		JToolBarHelper::save('country.save', 'JTOOLBAR_SAVE');
		//JToolBarHelper::save2new('country.save2new', 'JTOOLBAR_SAVE_AND_NEW');
