...
class CostbenefitprojectionViewCurrencies extends JView
{
	protected $items;
	...
	{	
		...
		JToolBarHelper::title(JText::_('COM_COSTBENEFITPROJECTION_CURRENCIES_TITLE'), 'currencies');
		...
		if ($canDo->get('core.delete')) {
			...
			if ($this->state->get('filter.published') == '-2') {
				// JToolBarHelper::deleteList('', 'urrencies.delete');
			} else {
