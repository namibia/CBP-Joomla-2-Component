...
class CostbenefitprojectionViewDisease extends JView
{
	protected $form;
	protected $item;
	protected $xml;
	...
	{	
		...
		if ($this->item->disease_id) {
			JToolBarHelper::title(JText::_('COM_COSTBENEFITPROJECTION_EDIT_DISEASE_TITLE'), 'disease-edit');
		} else {
			JToolBarHelper::title(JText::_('COM_COSTBENEFITPROJECTION_ADD_DISEASE_TITLE'), 'disease-add');
		}

		JToolBarHelper::apply('disease.apply', 'JTOOLBAR_APPLY');
		JToolBarHelper::save('disease.save', 'JTOOLBAR_SAVE');
		JToolBarHelper::save2new('disease.save2new', 'JTOOLBAR_SAVE_AND_NEW');
		JToolBarHelper::save2copy('disease.save2copy');

		JToolBarHelper::cancel('disease.cancel');
