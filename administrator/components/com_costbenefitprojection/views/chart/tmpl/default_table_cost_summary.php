...
<?php echo JText::_('COM_COSTBENEFITPROJECTION_TABLE_TOTAL_COST_CONTRIBUTION_ALL_TITLE'); ?>
        ...
        <table id="theTableCS_<?php echo $scale; ?>" class="table data metro-blue <?php echo $scale; ?>" style="display: <?php echo ($scale == 'unscaled') ? 'table' : 'none'; ?>;" data-page-size="50">
            <thead>        
                <tr >
                    ...
                    <th width="13%"><?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_COST_MORBIDITY_LABEL'); ?></th>
                    <th width="13%"><?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_COST_PRESENTEEISM_LABEL'); ?></th>
                    <th width="13%"><?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_COST_MORTALITY_LABEL'); ?></th>
                    <th width="13%"><?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_TOTAL_LOST_COST_PER_DR_LABEL'); ?></th>
                    <th width="13%"><?php echo JText::_('COM_COSTBENEFITPROJECTION_CT_PERCENT_TOTAL_COST_PER_DR_LABEL'); ?></th>
                </tr>        
            </thead>                                    
            <tbody>
