...
class CostbenefitprojectionViewDiseasedata extends JView
{
	...
	public function addToolbar()
	{
		...
		if ($this->item->id) {
			JToolBarHelper::title(JText::_('COM_COSTBENEFITPROJECTION_EDIT_DISEASEDATA_TITLE'), 'diseasedata-edit');
		} else {
			JToolBarHelper::title(JText::_('COM_COSTBENEFITPROJECTION_ADD_DISEASEDATA_TITLE'), 'diseasedata-add');
		}

		JToolBarHelper::apply('diseasedata.apply', 'JTOOLBAR_APPLY');
		JToolBarHelper::save('diseasedata.save', 'JTOOLBAR_SAVE');
		JToolBarHelper::custom('diseasedata.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
		JToolBarHelper::save2copy('diseasedata.save2copy');
		JToolBarHelper::cancel('diseasedata.cancel');
