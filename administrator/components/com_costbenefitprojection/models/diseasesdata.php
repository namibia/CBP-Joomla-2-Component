...
class CostbenefitprojectionModelDiseasesdata extends JModelList
{
	...
	public function getListQuery()
	{
		...
		if (!empty($search)) {
			...
			$field_searches =
				"(a.disease_name LIKE {$search} OR " .
				"c.diseasecategory_name LIKE {$search})";
	...
	protected function checkInNow()
	{
		...
		if ($time){
			...
			// Check table
			$query->update($db->quoteName('#__costbenefitprojection_diseasedata'))->set($fields)->where($conditions); 
